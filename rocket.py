...
def Mass_of_spaceship(wet_mass, mass_flow, mass_ship, i):
    ...
    Args:
        ...
        mass_flow (float): Amount of fuel expelled per timestep (thrust / Isp)
...
def Force_Gravity(mass_ship, altitude, MASS_BODY, RADIUS_BODY, STANDARD_GRAVITY_BODY):
    ...
    Args:
        ...
        altitude (float): The altitude of the rocket above Mean Sea level
         - stadart gravity parametr
        MASS_BODY = 5.972 * 10**24 - mass body
        RADIUS_BODY = 6.371 * 10**6  #meters radius body in meters
        STANDARD_GRAVITY_BODY = 9.80665  # m/s^2
...
def Main_simulation(thrust, motor_isp, mass_flow, dry_mass, wet_mass, reference_area, MASS_BODY, RADIUS_BODY, STANDARD_GRAVITY_BODY): 
    ...
    while mass_ship > dry_mass:  # and y_max < 120000:
        ...
        acceleration = Acceleration(thrust, force_gravity, mass_ship, force_drag)  #, force_drag)
